...
export const AuthPage: React.FC<AuthPageProps> = ({ onSuccess, onBack }) => {
    ...
    const handleOAuth = async (provider: 'google' | 'github') => {
        ...
        try {
            ...
            // OAuth redirects, so onSuccess will be called after redirect
        } catch (err: any) {
                    ...
                    <div className="bg-white rounded-2xl shadow-xl p-6 sm:p-8 border border-slate-100">
                        ...
                        <div className="space-y-3 mb-6">
                            <button
                                ...
                                className="w-full flex items-center justify-center gap-3 px-4 py-3 bg-white border-2 border-slate-200 rounded-lg font-medium text-slate-700 hover:bg-slate-50 hover:border-slate-300 transition-all"
                            >
                            ...
                            <button
                                ...
                                className="w-full flex items-center justify-center gap-3 px-4 py-3 bg-slate-900 border-2 border-slate-900 rounded-lg font-medium text-white hover:bg-slate-800 transition-all"
                            >

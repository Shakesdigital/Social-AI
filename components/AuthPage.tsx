                ...
                <div className="w-full max-w-md">
                    ...
                    <div className="text-center mb-6">
                        <h1 className="text-2xl sm:text-3xl font-bold text-slate-900">
                            {mode === 'login' ? 'Welcome Back' : 'Welcome to Market MI'}
                        </h1>
                    ...
                    <div className="bg-white rounded-2xl shadow-lg border border-slate-200 p-6 sm:p-8">
                        ...
                        <div className="space-y-3 mb-6">
                            ...
                            >
                                ...
                                {isOAuthLoading === 'google' ? 'Connecting...' : (mode === 'login' ? 'Continue with Google' : 'Sign up with Google')}
                            </button>
                            ...
                            >
                                ...
                                {isOAuthLoading === 'github' ? 'Connecting...' : (mode === 'login' ? 'Continue with GitHub' : 'Sign up with GitHub')}
                            </button>
                        </div>
